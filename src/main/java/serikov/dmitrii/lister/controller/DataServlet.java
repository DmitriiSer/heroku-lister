...
//			if (sessionRemoteIP != null && sessionRemoteIP.equals(request.getRemoteAddr()) && sessionUsername != null) {
//				// connect to database
...
//						// if there is a reference to a local file with list
//						// content
//						if (DataRef != null) {
...
//							logger.info("User [" + sessionRemoteIP
//									+ "] requested list content for the list with name \"" + paramListname + "\"");
...
//							// "ServerError: Internal error. File cannot be
//							// removed from the database");
//							throw new IOException(
//									"DataServlet cannot remove list " + paramListname + " from the database");
//						}
//					} // wrong request
//					else {
...
//						String listContent = (String) Utils.fromJson(DataServlet.class.getName(), request,
//								String.class);
...
//							response.sendError(HttpServletResponse.SC_CONFLICT, "ServerError: The list with name["
//									+ paramListname + "] already exists in database");
...
//									UserList userList = new UserList(paramListname, listContent,
//											UserList.CREATED_BY_SERVER);
//									Utils.sendResponse(DataServlet.class.getName(), response, userList);
//									logger.info("List with name \"" + paramListname + "\" was created in user ["
//											+ sessionRemoteIP + "] profile");
//								} // there is no a reference to a local file in
//									// database
//								else {
//									throw new IOException("DataServlet cannot get data reference from the database");
//								}
...
//								response.sendError(HttpServletResponse.SC_CONFLICT, "ServerError: The list with name["
//										+ paramListname + "] cannot be created in database");
//								throw new IOException("DataServlet cannot create a list in database");
//							}
//						}
//					} // change list content
...
//							// set list content
//							FileUtils.setFileContent(DataRef, listContent);
//							// UserList userList = new UserList(paramListname,
//							// listContent, UserList.CREATED_BY_USER);
//							// Utils.sendResponse(DataServlet.class.getName(),
//							// response, userList);
//						} // there is no a reference to a local file in database
//						else {
//							throw new IOException("DataServlet cannot get data reference from the database");
...
//						String reorderListsContent = (String) Utils.fromJson(DataServlet.class.getName(), request,
//								String.class);

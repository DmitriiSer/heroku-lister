...
import static serikov.dmitrii.lister.utils.Utils.errorMesage;
...
public class FileUtils {
	...
	private static final XLogger logger = XLoggerFactory.getXLogger(FileUtils.class);
	...
	public static void renameListFile(String username, String oldListTitle, String newListTitle) throws IOException {
		try {
			Path oldFilePath = Paths.get(currentDirectory + File.separator + "data" + File.separator + username + "_"
					+ oldListTitle + ".dt");
			Path newFilePath = Paths.get(currentDirectory + File.separator + "data" + File.separator + username + "_"
					+ newListTitle + ".dt");
			...
			logger.info("The file with name '" + oldFilePath.getFileName() + "' was renamed to '"
